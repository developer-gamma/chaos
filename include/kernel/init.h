...
enum	init_level
{
	...
	CHAOS_INIT_LEVEL_MULTIBOOT	= 0x40000,

	CHAOS_INIT_LEVEL_PMM		= 0x50000,
	CHAOS_INIT_LEVEL_UTESTS_PMM	= 0x60000,
	CHAOS_INIT_LEVEL_VMM		= 0x70000,
	CHAOS_INIT_LEVEL_UTESTS_VMM	= 0x80000,

	CHAOS_INIT_LEVEL_BDEV		= 0x90000,
	CHAOS_INIT_LEVEL_FILESYSTEM	= 0xA0000,

	CHAOS_INIT_LEVEL_ARCH		= 0xB0000,
	CHAOS_INIT_LEVEL_PLATFORM	= 0xC0000,

	CHAOS_INIT_LEVEL_UTESTS		= 0xD0000,
